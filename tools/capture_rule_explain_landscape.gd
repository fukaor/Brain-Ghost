## Capture helper — rule_explain_landscape.tscn
##
## 実行: godot --path /workspace --script tools/capture_rule_explain_landscape.gd
extends SceneTree

const OUTPUT_PATH := "res://.steering/20260512-ゴースト7番勝負カウントダウン統一/capture_rule_explain_landscape.png"
const SCENE_PATH := "res://scenes/ui/rule_explain_landscape.tscn"
