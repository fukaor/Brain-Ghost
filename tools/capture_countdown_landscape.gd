## Capture helper — countdown_landscape.tscn
##
## 実行: godot --path /workspace --script tools/capture_countdown_landscape.gd
extends SceneTree

const OUTPUT_PATH := "res://.steering/20260512-ゴースト7番勝負カウントダウン統一/capture_countdown_landscape.png"
const SCENE_PATH := "res://scenes/ui/countdown_landscape.tscn"
